 ...
 * Use the [QuestionsList2.newInstance] factory method to
 * create an instance of this fragment.
 */
class QuestionsList2 : Fragment(),TextToSpeech.OnInitListener {
    // TODO: Rename and change types of parameters
    private val Table_Name: String? = "VISITOR"
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_questions_list2, container, false)
        val spinner = view.findViewById<Spinner>(R.id.spinnerlist2)
        val spinnerCat = view.findViewById<Spinner>(R.id.spinner3)
        val answer : TextView = view.findViewById(R.id.answerlist2)
        ...
        val readData1 : ArrayList<DatabaseTrace> = database.selectQuestions("General")
        val readData2 : ArrayList<DatabaseTrace> = database.selectQuestions("Sites")
        val size : Int = readData.size
        val size1 : Int = readData1.size
        val size2 : Int = readData2.size
        val category = arrayOf("Category","General","Sites")
        val items = arrayOfNulls<String>(size + 1)
        val items1 = arrayOfNulls<String>(size1 + 1)
        val items2 = arrayOfNulls<String>(size2 + 1)
        buttonSpeak = view.findViewById(R.id.button)
    ...
    companion object {
         ...
         * @return A new instance of fragment QuestionsList2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            QuestionsList2().apply {
